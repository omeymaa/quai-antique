        ...
        <div class="col-9 col-lg-9">
            ...
            <form method="POST" id="signup-form" class="py-4">
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <div class="form-outline">
                            ...
                            <input type="text" id="firstname" class="form-control form-control-sm" placeholder="Prénom" name="firstname" />
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        <div class="form-outline">
                            <span class="form-label" for="lastname"></span>
                            <input type="text" id="lastname" class="form-control form-control-sm" placeholder="Nom" name="lastname" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="email" id="email" class="form-control form-control-sm" placeholder="E-mail" name="email" />
                </div>

                <div class="form-outline mb-4">
                    <span class="form-label" for="password"></span>
                    <input type="password" id="password" class="form-control form-control-sm" placeholder="Mot de passe" name="password" />
                </div>

                <div class="form-outline mb-4">
                    <span class="form-label" for="confirm_password"></span>
                    <input type="password" id="confirm_password" name="confirm_password" class="form-control form-control-sm" placeholder="Confirmez le mot de passe" />
                </div>
